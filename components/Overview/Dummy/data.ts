    ...
    tasks: [
      {
        ...
        description: "Review JWT login and signup code.",
        assignee: sampleUsers[2],
        comments: 1,
        attachments: 1,
        workItems: 8,
      ...
      {
        id: "TASK-702",
        title: "UI review of dashboard widgets",
        description: "Check responsiveness and UX.",
        assignee: sampleUsers[3],
        comments: 2,
        attachments: 0,
        workItems: 5,
      ...
      },
      {
        ...
        description: "Run security audit on new APIs.",
        assignee: sampleUsers[4],
        comments: 3,
        attachments: 1,
        workItems: 15,
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: "Setup project scaffolding.",
        assignee: sampleUsers[6],
        comments: 1,
        attachments: 0,
        workItems: 10,
      ...
      },
      {
        ...
        description: "Conduct initial user interviews.",
        assignee: sampleUsers[7],
        comments: 4,
        attachments: 2,
        workItems: 12,

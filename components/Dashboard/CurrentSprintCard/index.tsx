...
export default function CurrentSprintCard({ sprint }: CurrentSprintCardProps) {
  ...
  return (
    <div className="rounded-xl shadow p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 w-full max-w-xl">
      ...
      <div className="grid grid-cols-4 gap-2 text-center mb-2">
        <div>
          ...
          <div className="text-xs uppercase text-gray-500">{t("days")}</div>
        </div>
        <div>
          <div className="text-xl font-mono font-semibold text-green-600">
            {countdown.hours}
          </div>
          <div className="text-xs uppercase text-gray-500">{t("hours")}</div>
        </div>
        <div>
          <div className="text-xl font-mono font-semibold text-green-600">
            {countdown.minutes}
          </div>
          <div className="text-xs uppercase text-gray-500">{t("minutes")}</div>
        </div>
        <div>
          <div className="text-xl font-mono font-semibold text-green-600">
            {countdown.seconds}
          </div>
          <div className="text-xs uppercase text-gray-500">{t("seconds")}</div>
        </div>
      </div>

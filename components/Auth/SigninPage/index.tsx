      ...
      >
        ...
        <div className="bg-gradient-to-br from-[#080f17] to-[#2c7ad4] py-6 px-4 text-center">
          <div className="flex flex-row justify-center items-center gap-2">
            ...
            <h1 className="text-white font-bold text-lg tracking-wide">YVO</h1>
          </div>
        ...
        <div className="flex flex-col gap-4 py-6 px-6">
          ...
          <Button
            ...
            onPress={() => alert("Microsoft auth integration not implemented")}
          >
            {t("microsoft")}
          </Button>
        </div>
        ...
        {/* Footer */}
        <div className="flex flex-col gap-2 pb-6 px-6 text-center">

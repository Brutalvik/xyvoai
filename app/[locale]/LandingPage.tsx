    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
          ...
          <div className="w-full flex flex-wrap sm:flex-nowrap gap-4 sm:gap-6 overflow-x-auto -mx-4 px-2 sm:mx-0 sm:px-0 scrollbar-hide">
            {/* To Do */}
            <div className="bg-gray-50 rounded-xl p-4 flex-1 min-w-[220px] flex-shrink-0">
            ...
            {/* In Progress */}
            <div className="bg-yellow-50 rounded-xl p-4 flex-1 min-w-[220px] flex-shrink-0">
              <div className="flex items-center gap-2 mb-2">
            ...
            {/* Review */}
            <div className="bg-blue-50 rounded-xl p-4 flex-1 min-w-[220px] flex-shrink-0">
              <div className="flex items-center gap-2 mb-2">
            ...
            {/* Done */}
            <div className="bg-green-50 rounded-xl p-4 flex-1 min-w-[220px] flex-shrink-0">
              <div className="flex items-center gap-2 mb-2">
